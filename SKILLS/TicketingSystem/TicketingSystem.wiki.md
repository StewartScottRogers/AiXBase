...
| `USER` | `TICKETING_USER_NOT_FOUND`, `TICKETING_USER_INACTIVE`, `TICKETING_USER_EMAIL_DUPLICATE`, `TICKETING_USER_USERNAME_DUPLICATE`, `TICKETING_USER_EMAIL_INVALID`, `TICKETING_USER_EMAIL_REQUIRED`, `TICKETING_USER_USERNAME_REQUIRED`, `TICKETING_USER_LAST_ADMIN`, `TICKETING_USER_IDENTIFIER_REQUIRED` |
